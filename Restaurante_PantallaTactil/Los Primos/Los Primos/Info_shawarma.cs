...
{
    public partial class Info_shawarma: UserControl
    {
        ...
        private void button_peque_Click(object sender, EventArgs e)
        {
            ...
            {
                aux = (Producto) shawarmas[0];

            }else if (tipoCarne.Contains("ternera"))
            {
                aux = (Producto) shawarmas[0+3];

            }
            else if (tipoCarne.Contains("cordero"))
            {
                aux = (Producto) shawarmas[0+3+3];
        ...
        private void button_medi_Click(object sender, EventArgs e)
        {
            ...
            if (tipoCarne.Contains("pollo"))
            {
                aux = (Producto) shawarmas[1];

            }
            else if (tipoCarne.Contains("ternera"))
            {
                aux = (Producto) shawarmas[1 + 3];

            }
            else if (tipoCarne.Contains("cordero"))
            {
                aux = (Producto) shawarmas[1 + 3 + 3];
        ...
        private void button_grand_Click(object sender, EventArgs e)
        {
            ...
            if (tipoCarne.Contains("pollo"))
            {
                aux = (Producto) shawarmas[2];

            }
            else if (tipoCarne.Contains("ternera"))
            {
                aux = (Producto) shawarmas[2 + 3];

            }
            else if (tipoCarne.Contains("cordero"))
            {
                aux = (Producto) shawarmas[2 + 3 + 3];
        ...
        private void Info_shawarma_VisibleChanged(object sender, EventArgs e)
        {
        ...
        private void Info_shawarma_Load(object sender, EventArgs e)
        {
